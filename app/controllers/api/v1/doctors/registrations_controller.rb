     ...
     skip_before_action :verify_authenticity_token, :only => [:create]
         ...
         def create
           ActiveRecord::Base.transaction do
             ...
             @doctor = resource
             render json: { doctor: resource, status: :success, message: "Doctor created successfully" }
           end
         end
        ...
        protected
           def configure_permitted_parameters
             param_keys = [:email, :password, :city_id, :gender, :age, :speciality, :education, :address, :phone_number, :first_name, :last_name]
